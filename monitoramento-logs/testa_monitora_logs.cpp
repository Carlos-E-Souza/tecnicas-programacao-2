...
TEST_CASE("Lista existe e total ausente cria total_", "[monitora_logs]") {
  ...
  std::remove("./output/total_log_existe.txt");

  REQUIRE(processa_lista_logs("./listas/lista_com_log_existe.txt"));

  std::ifstream total("./output/total_log_existe.txt");
...
TEST_CASE("Lista existe e total existe faz merge ordenado", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_existe.txt");
  std::ofstream total_base("./output/total_log_existe.txt");
...
TEST_CASE("Log vazio com total existente mantem total_", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_vazio.txt");
  std::ofstream total_base("./output/total_log_vazio.txt");
  REQUIRE(total_base.is_open());
  total_base << "17/1/2026 14:17:46 Log do total" << "\n";
  total_base << "21/1/2026 18:55:38 Outro total";
  total_base.close();
  ...
  std::ifstream total("./output/total_log_vazio.txt");
  REQUIRE(total.is_open());
...
TEST_CASE(
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_misto.txt");

  REQUIRE(processa_lista_logs("./listas/lista_com_log_misto.txt"));

  std::ifstream total("./output/total_log_misto.txt");
  REQUIRE(total.is_open());
...
TEST_CASE("Regex parse sucesso cria total_", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_parse_ok.txt");

  REQUIRE(processa_lista_logs("./listas/lista_parse_ok.txt"));

  std::ifstream total("./output/total_log_parse_ok.txt");
  REQUIRE(total.is_open());
...
TEST_CASE("Regex parse falha gera total_ vazio", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_parse_fail.txt");

  REQUIRE(processa_lista_logs("./listas/lista_parse_fail.txt"));

  std::ifstream total("./output/total_log_parse_fail.txt");
  REQUIRE(total.is_open());
...
TEST_CASE("Merge ordenado onde total vence", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_total_wins.txt");
  std::ofstream total_base("./output/total_log_total_wins.txt");
  REQUIRE(total_base.is_open());
  ...
  std::ifstream total("./output/total_log_total_wins.txt");
  REQUIRE(total.is_open());
...
TEST_CASE("Merge ordenado onde log vence", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_log_wins.txt");
  std::ofstream total_base("./output/total_log_log_wins.txt");
  REQUIRE(total_base.is_open());
  total_base << "15/1/2026 12:00:00 Linha do total";
  total_base.close();
  ...
  std::ifstream total("./output/total_log_log_wins.txt");
  REQUIRE(total.is_open());
...
TEST_CASE(
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_empate.txt");
  std::ofstream total_base("./output/total_log_empate.txt");
  REQUIRE(total_base.is_open());
  total_base << "15/1/2026 12:00:00 Linha do total";
  total_base.close();
  ...
  std::ifstream total("./output/total_log_empate.txt");
  REQUIRE(total.is_open());
...
TEST_CASE("Logs com mesmo basename agregam em um total_", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log1.txt");

  REQUIRE(processa_lista_logs("./listas/lista_multidir.txt"));

  std::ifstream total("./output/total_log1.txt");
  REQUIRE(total.is_open());
...
TEST_CASE("Lista com multiplos arquivos processa em ordem", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_a.txt");
  std::remove("./output/total_log_b.txt");

  REQUIRE(processa_lista_logs("./listas/lista_duas_entradas.txt"));

  std::ifstream total_a("./output/total_log_a.txt");
  REQUIRE(total_a.is_open());
  std::string linha;
  REQUIRE(std::getline(total_a, linha));
  REQUIRE(linha == "10/1/2026 10:00:00 Log A");

  std::ifstream total_b("./output/total_log_b.txt");
...
TEST_CASE("Caminho com barras invertidas e normalizado", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_backslash.txt");

  REQUIRE(processa_lista_logs("./listas/lista_backslash.txt"));

  std::ifstream total("./output/total_log_backslash.txt");
  REQUIRE(total.is_open());
...
TEST_CASE("Fim a fim com multiplos logs ordenados", "[monitora_logs]") {
  ...
  REQUIRE(garante_diretorio_output());
  std::remove("./output/total_log_e2e_a.txt");
  std::remove("./output/total_log_e2e_b.txt");

  REQUIRE(processa_lista_logs("./listas/lista_e2e.txt"));

  std::ifstream total_a("./output/total_log_e2e_a.txt");
  REQUIRE(total_a.is_open());
  std::string linha;
  REQUIRE(std::getline(total_a, linha));
  ...
  std::ifstream total_b("./output/total_log_e2e_b.txt");
  REQUIRE(total_b.is_open());
  REQUIRE(std::getline(total_b, linha));
